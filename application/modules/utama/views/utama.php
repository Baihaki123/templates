...
<head>
  ...
  <!-- fevicon -->
  <!-- <link rel="icon" href="<?php echo base_url('assets/templates/images/fevicon.png'); ?>" type="image/gif" /> -->
  <!-- bootstrap css -->
  <link rel="stylesheet" href="<?php echo base_url('assets/templates/css/bootstrap.min.css'); ?>">
  <!-- style css -->
  <link rel="stylesheet" href="<?php echo base_url('assets/templates/css/style.css'); ?>">
  <!-- Responsive-->
  <link rel="stylesheet" href="<?php echo base_url('assets/templates/css/responsive.css'); ?>">  
  <!-- Scrollbar Custom CSS -->
  <link rel="stylesheet" href="<?php echo base_url('assets/templates/css/jquery.mCustomScrollbar.min.css'); ?>">
...
<body class="main-layout">
  <!-- loader  -->
  <div class="loader_bg">
    <div class="loader"><img src="<?php echo base_url('assets/templates/images/loading.gif'); ?>" alt="#" /></div>
  </div>
  <!-- end loader -->
  <!-- header -->
  <header>
          ...
          <div class="row">
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-3 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href="#"><img src="<?php echo base_url('assets/templates/images/logo.png'); ?>" alt="#" /></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-10 col-lg-8 col-md-8 col-sm-9">
              <div class="header_information">
               ...
               <div class="mean-last">
                    <a href="#"><img src="<?php echo base_url('assets/templates/images/search_icon.png'); ?>" alt="#" /></a> <a href="#">login/sing up</a></div>              
             </div>
           </div>
         </div>
       </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                    <div class="images_box">
                      <figure><img src="<?php echo base_url('assets/templates/images/img2.png'); ?>"></figure>
                    </div>
                  </div>
                </div>
              </div>
...
<div id="about" class="about">
  <div class="container">
    <div class="row">
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <figure><img src="<?php echo base_url('assets/templates/images/about.jpg'); ?>" alt="#" /></figure>
        </div>
      </div>
    </div>
        ...
        <div class="box_bg">
          <div class="box_bg_img">
            <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<?php echo base_url('assets/templates/images/my1.jpg'); ?>"></figure>
                  <div class="overlay">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<?php echo base_url('assets/templates/images/my2.jpg'); ?>"></figure>
                  <div class="overlay">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<img src="<?php echo base_url('assets/templates/images/my3.jpg'); ?>"></figure>
                  <div class="overlay">
                    <h3>Skills</h3>
                    <p>It is a long established fact that a reader will be distracted by the readable content o</p>
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<img src="<?php echo base_url('assets/templates/images/my4.jpg'); ?>"></figure>
                  <div class="overlay">
...
<div id="learn" class="learn">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="learn_box">
          <figure><img src="<?php echo base_url('assets/templates/images/img.jpg'); ?>" alt="img"/></figure>
        </div>
      </div>
    </div>
  </div>
...
<div class="make">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
        <div class="make_img">
          <figure><img src="<?php echo base_url('assets/templates/images/make_img.jpg'); ?>"></figure>
        </div>
      </div>
    </div>
  </div>
    ...
    <footr>
      <div class="footer ">
        <div class="container">
              ...
              <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 ">
                  <div class="address">
                    ...
                    <ul class="loca">
                      <li>
                        <a href="#"><img src="<?php echo base_url('assets/templates/icon/loc.png'); ?>" alt="#" /></a>London 145
                        <br>United Kingdom </li>
                        <li>
                          <a href="#"><img src="<?php echo base_url('assets/templates/icon/email.png'); ?>" alt="#" /></a>demo@gmail.com </li>
                          <li>
                            <a href="#"><img src="<?php echo base_url('assets/templates/icon/call.png'); ?>" alt="#" /></a>+12586954775 </li>
                          </ul>
                          <ul class="social_link">
                            <li><a href="#"><img src="<?php echo base_url('assets/templates/icon/fb.png'); ?>"></a></li>
                            <li><a href="#"><img src="<?php echo base_url('assets/templates/icon/tw.png'); ?>"></a></li>
                            <li><a href="#"><img src="<?php echo base_url('assets/templates/icon/lin(2).png'); ?>"></a></li>
                            <li><a href="#"><img src="<?php echo base_url('assets/templates/icon/instagram.png'); ?>"></a></li>
                          </ul>
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 ">
                        <div class="address">
                          <a href="index.html"> <img src="<?php echo base_url('assets/templates/images/logo1.jpg'); ?>" alt="logo"></a>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <!-- end footer -->
          <!-- Javascript files-->
          <script src="<?php echo base_url('assets/templates/js/jquery.min.js'); ?>"></script>
          ...
          <script src="<?php echo base_url('assets/templates/js/jquery-3.0.0.min.js'); ?>"></script>
          <script src="<?php echo base_url('assets/templates/js/plugin.js'); ?>"></script>
          <!-- sidebar -->
          <script src="<?php echo base_url('assets/templates/js/jquery.mCustomScrollbar.concat.min.js'); ?>"></script>
...
<script>
var selector = '.menu-area-main li';
